...
_BRAND_MAPPINGS: dict[str, list[str]] = {
    ...
    "greencos co., ltd.": ["Beauty of Joseon"],
    "lg household&healthcare ltd.": ["The Face Shop"],
    "huen cosmetics co., ltd": ["SKIN1004"],
    "cotheon co., ltd": ["IUNIK"],
    "dfs co., ltd": ["Haruharu Wonder"],
    "gdk cosmetics co., ltd": ["Haruharu Wonder"],
    "hinature inc.": ["PURITO"],
    "englewoodlab us": ["mixsoon"],
    "englewood lab, inc.": ["Anua"],
    "cnf co.,ltd": ["ANUA"],
    "megacos co.ltd": ["Anua"],
    "megacos": ["Anua"],
    "jincostech co., ltd": ["mixsoon"],
    "minustory co., ltd": ["Arencia"],
    "imine co., ltd oliveinternational inc.": ["SUNGBOON EDITOR"],
    "nowcos co., ltd.": ["SUNGBOON EDITOR"],
    "forest avenue co., ltd. cosmecca co. ltd": ["MENOKIN"],
    "ls cosmetic co., ltd.": ["MEDIHEAL"],
    "dongkook pharmaceutical co., ltd": ["CENTELLIAN 24"],
    "tonymoly co. ltd": ["TONYMOLY"],
    "tonymoly co ltd": ["TONYMOLY"],
    "skin food since 1957": ["SKINFOOD"],
    "have & be usa, inc., us_luxury_beauty, 989n4": ["Dr.Jart+"],
    "nature republic co.,ltd": ["Nature Republic"],
    "proso inc.": ["NIDA"],
    "adapt inc.": ["FULLY"],
    "bmcos co., ltd.": ["BRMUD"],
    "dermal korea co.,ltd.": ["DERMAL"],
    ...
    "atlas ethnic": ["Fantasia"],
    "fantasia industries corporation": ["Fantasia"],
    "idelle labs, ltd.": ["Seabreeze"],
    "tree of life beauty": ["Tree of Life"],
    "bridges chc": ["Albolene"],
    "green mask stck": ["Green Mask Stick"],
    "carma labs, inc": ["Carmex"],
    "carma laboratories": ["Carmex"],
    "kiehl's since 1851": ["Kiehl's"],
    "markwins beauty brands": ["Lip Smacker"],
    "naterra international, inc.": ["Tree Hut"],
    "vogue international": ["Maui Moisture"],
    "blistex, inc.": ["Blistex", "Stridex"],
    "crown laboratories, inc.": ["PanOxyl", "Blue Lizard"],
    "dickinson brands, inc": ["Dickinson's", "T.N. Dickinson's", "Humphreys"],
    "bubble skincare": ["Bubble Skincare"],
    "l'oreal - skincare": ["CeraVe", "La Roche-Posay"],
    "scope health inc.": ["OPTASE"],
}
