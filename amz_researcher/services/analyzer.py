...
def calculate_weights(
    ...
    # Category Summary는 Featured 성분만으로 집계 (INCI 전용 제외)
    featured_rankings = [r for r in rankings if r.featured_count > 0]
    categories = _aggregate_categories(featured_rankings, weighted_products)
